...
},{"rx":79}],2:[function(require,module,exports){
"use strict";
...
},{"./render-dom":7,"rx":79}],3:[function(require,module,exports){
"use strict";
...
},{"./custom-element-widget":2,"es6-map":59}],4:[function(require,module,exports){
"use strict";
...
},{"./mock-dom-response":6,"./render-dom":7,"./render-html":8,"./virtual-hyperscript":10,"virtual-dom/virtual-hyperscript/svg":105}],5:[function(require,module,exports){
"use strict";
...
},{"rx":79}],6:[function(require,module,exports){
'use strict';
...
},{"rx":79}],7:[function(require,module,exports){
"use strict";
...
},{"./custom-elements":3,"./fromevent":5,"./transposition":9,"./virtual-hyperscript":10,"matches-selector":77,"rx":79,"vdom-parser":84,"virtual-dom/diff":91,"virtual-dom/patch":92}],8:[function(require,module,exports){
"use strict";
...
},{"./custom-element-widget":2,"./custom-elements":3,"./transposition":9,"rx":79,"vdom-to-html":88}],9:[function(require,module,exports){
"use strict";
...
},{"rx":79,"virtual-dom/vnode/vnode":113}],10:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
},{"es5-ext/object/primitive-set":37}],63:[function(require,module,exports){
'use strict';
...
},{"./iterator-kinds":62,"d":15,"es5-ext/object/set-prototype-of":38,"es6-iterator":50,"es6-symbol":65}],64:[function(require,module,exports){
'use strict';
...
},{"./is-native-implemented":61,"./lib/iterator":63,"d":15,"es5-ext/array/#/clear":16,"es5-ext/array/#/e-index-of":17,"es5-ext/object/set-prototype-of":38,"es5-ext/object/valid-callable":41,"es5-ext/object/valid-value":42,"es6-iterator/for-of":48,"es6-iterator/valid-iterable":58,"es6-symbol":65,"event-emitter":70}],65:[function(require,module,exports){
arguments[4][52][0].apply(exports,arguments)
},{"./is-implemented":66,"./polyfill":67,"dup":52}],66:[function(require,module,exports){
'use strict';
...
},{"d":15}],68:[function(require,module,exports){
/*!
 * escape-html
...
},{"individual/one-version":74}],70:[function(require,module,exports){
'use strict';
...
},{"d":15,"es5-ext/object/valid-callable":41}],71:[function(require,module,exports){
(function (global){
...
},{"min-document":12}],72:[function(require,module,exports){
'use strict';
...
},{"sentence-case":80}],79:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":81,"./vendor/non-word-regexp":82,"./vendor/trailing-digit-regexp":83,"lower-case":76}],81:[function(require,module,exports){
...
},{"./namespace-map":85,"./property-map":86,"virtual-dom/vnode/vnode":113,"virtual-dom/vnode/vtext":115}],85:[function(require,module,exports){
...
},{"./property-config":89,"escape-html":68}],88:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":87,"./void-elements":90,"escape-html":68,"param-case":78,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":99,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":101,"virtual-dom/vnode/is-thunk":107,"virtual-dom/vnode/is-vnode":109,"virtual-dom/vnode/is-vtext":110,"virtual-dom/vnode/is-widget":111,"xtend":119}],89:[function(require,module,exports){
/**
 * Attribute types.
 */
...
},{"./vtree/diff.js":117}],92:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":108,"is-object":75}],94:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":106,"../vnode/is-vnode.js":109,"../vnode/is-vtext.js":110,"../vnode/is-widget.js":111,"./apply-properties":93,"global/document":71}],95:[function(require,module,exports){
...
},{"./create-element":94,"./dom-index":95,"./patch-op":96,"global/document":71,"x-is-array":118}],98:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":69}],101:[function(require,module,exports){
'use strict';
...
},{"browser-split":11}],104:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":108,"is-object":75}],117:[function(require,module,exports){
var isArray = require("x-is-array")
...
var _cycleWebsocketDriver = require('./cycle-websocket-driver');
...
var _Helpers = (0, _hyperscriptHelpers2.default)(_dom.h);

var div = _Helpers.div;
var ul = _Helpers.ul;
var li = _Helpers.li;
...
function view(state$) {
  return state$.map(function (messages) {
    return div([(0, _dom.h)('message-input.js-message-input'), ul(messages.map(function (content) {
      return li([content]);
    }))]);
  });
}
...
function makeWebSocketDriver(url) {
  ...
  var open$ = _rx2.default.Observable.fromEvent(ws, 'open');
  return function webSocketDriver(outgoing$) {
    outgoing$.skipUntil(open$).subscribe(function (message) {
      return ws.send(message);
    });
    return _rx2.default.Observable.fromEvent(ws, 'message').pluck('data');
  };
};
...
var form = _Helpers.form;
var button = _Helpers.button;
var input = _Helpers.input;

function intent(DOM) {
  var inputValue$ = DOM.select('[data-js-text]').events('input').pluck('target', 'value');
  var sendRequest$ = DOM.select('[data-js-form]').events('submit').map(function (event) {
    return event.preventDefault();
  });
  var newMessage$ = inputValue$.sample(sendRequest$);
...
function model(actions) {
  var inputValue$ = _rx2.default.Observable.merge(actions.inputValue$, actions.sendRequest$.map('')).startWith('');

  return inputValue$;
}

function view(state$) {
  return state$.map(function (inputValue) {
    return form({ attributes: { 'data-js-form': '' } }, [input({
      type: 'text',
      value: inputValue,
      attributes: {
        'data-js-text': ''
...
},{"@cycle/dom":4,"hyperscript-helpers":72,"rx":79}]},{},[120]);
